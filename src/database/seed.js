...
async function main() {
  ...
  const siswaData = [
    { username: 'Budi Santoso', email: 'budi@gmail.com' },    // sudah ada, skip kalau error
    { username: 'Ani Putri', email: 'ani@gmail.com' },
    { username: 'Dimas Prasetyo', email: 'dimas@gmail.com' },
    { username: 'Sari Dewi', email: 'sari@gmail.com' },
    { username: 'Rizki Aditya', email: 'rizki@gmail.com' },
    { username: 'Maya Lestari', email: 'maya@gmail.com' },
    { username: 'Fajar Nugroho', email: 'fajar@gmail.com' },
  ]
  ...
  for (const s of siswaData) {
    ...
    const user = await prisma.user.upsert({
      where: { email: s.email },
      update: {},
      create: { username: s.username, email: s.email, passwordHash, role: 'student' }
    })
    siswaList.push(user)
  ...
  for (const siswaScore of skorData) {
    ...
    console.log(`  ✓ hasil tes ${siswa.username} selesai`)
  }
  ...
  for (const r of riskData) {
    ...
    console.log(`  ✓ risk flag ${siswa.username} (${r.level})`)
  }
